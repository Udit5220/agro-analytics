...
import AdminPanel from "./pages/research-ai/AdminPanel";
import ModelSettings from "./pages/research-ai/ModelSettings";
import NewsIntelligenceModule from "./pages/news-intel/NewsIntelligenceModule";
...
import ResearchInsightsExplorer from "./pages/research-ai/ResearchInsightsExplorer";
import AiWhitePaperGenerator from "./pages/research-ai/AiWhitePaperGenerator";
import AgriculturalTrendIntelligence from "./pages/research-ai/AgriculturalTrendIntelligence";
import PolicyResearchCenter from "./pages/research-ai/PolicyResearchCenter";
import ResearchRecommendationEngine from "./pages/research-ai/ResearchRecommendationEngine";
import { CommercialTrendDiscovery, ForecastingAssistant, RiskMitigationSuite } from "./pages/research-ai/AgribusinessComponents";
import { DistrictIntervention, PolicyRecommendations, SchemeIntelligence, EmergencyReliefManager, TradeExportDashboard } from "./pages/research-ai/GovernmentComponents";
import { ComprehensiveAnalyticsDashboard, KnowledgeBaseManager, PromptManager, AIModelLanguageManager } from "./pages/research-ai/AdminComponents";
import ResearchConfigPanel from './pages/research-ai/ResearchConfigPanel';
...
function DashboardSwitcher() {
  ...
  // ── Restricted App Routes (White Paper Research and AI ONLY) ─────────
  ...
  if (moduleId === 'news-intel') {
    return <NewsIntelligenceModule subPath={subPath} />;
  }
  // ── Marketplace (NEW) ─────────────────────────────────────────────────────
