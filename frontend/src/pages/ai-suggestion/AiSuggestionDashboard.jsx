...
import bannerImg from "../../assets/images/AI Agriculture Assistant.png";
...
export default function AiSuggestionDashboard() {
  const metrics = [
    ...
    {
      label: "Climate Warnings",
      value: "4",
      sub: "Outbreaks monitored",
      color: "text-red-700 bg-red-50",
    },
    {
      label: "Soil Quality Status",
      value: "Optimal",
      sub: "Telemetry scan",
      color: "text-[#31572c] bg-[#31572c]/10",
    },
    {
      label: "Advice Queries Today",
      value: "148",
      sub: "Conversations processed",
        ...
        <div className="relative z-10 w-full md:w-2/3">
          <div>
            ...
            <p className="text-gray-500 text-[11px] md:text-xs font-medium mt-1.5">
              Consult 24/7 conversational multi-model LLM agronomists to
              optimize crop care and irrigation.
            </p>
          </div>
        </div>
        ...
        <div className="lg:col-span-2 bg-white rounded-2xl border border-gray-200/60 shadow-sm overflow-hidden flex flex-col h-[400px]">
          ...
          <div className="flex-1 p-4 overflow-y-auto space-y-3.5 text-xs">
            <div className="flex gap-2.5">
              ...
              <div className="bg-[#f4f7f4] border border-gray-100 rounded-xl p-3 max-w-[80%]">
                ...
                <p className="text-gray-650 leading-relaxed font-medium">
                  Welcome to AgroIndia AI. I have analyzed Faridabad region's
                  soil matrices. Current nitrogen levels are optimal, but
                  rainfall forecasts predict a humid spell next Tuesday. How can
                  I help you manage your fields today?
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-2.5 flex-row-reverse">
              ...
              <div className="bg-[#31572c] text-white rounded-xl p-3 max-w-[80%]">
                <p className="leading-relaxed font-semibold">
                  What is the best NPK ratio and irrigation frequency for Wheat
            ...
            <div className="flex gap-2.5">
              ...
              <div className="bg-[#f4f7f4] border border-gray-100 rounded-xl p-3 max-w-[80%]">
                <p className="text-gray-650 leading-relaxed font-medium">
                  For Wheat in vegetative stage, the optimal NPK recipe is
                  **120-60-40**. You should schedule irrigation cycles every
                  10–12 days based on current soil water retention bounds. Keep
                  field moisture moderate, avoiding stagnation.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="bg-emerald-50/50 border border-emerald-100 p-3 rounded-xl flex gap-2">
              ...
              <div>
                ...
                <span className="text-[11px] text-gray-600 block mt-0.5 leading-relaxed">
                  Schedule water supply before morning sun to minimize
                  evaporative loss.
                </span>
              </div>
            </div>
            ...
            <div className="bg-amber-50/50 border border-amber-100 p-3 rounded-xl flex gap-2">
              ...
              <div>
                <span className="text-[10px] font-bold text-amber-900 block">
                  NPK Target Recommendation
                </span>
                <span className="text-[11px] text-gray-600 block mt-0.5 leading-relaxed">
                  Nitrogen is slightly heavy. Divert to potash base next week to
                  protect grain fill.
                </span>
              </div>
            </div>
