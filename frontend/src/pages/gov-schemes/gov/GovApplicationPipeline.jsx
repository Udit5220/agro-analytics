...
export default function GovApplicationPipeline() {
  ...
  const columns = [
    ...
    { header: "TOTAL FILED", accessor: "total", sortable: true },
    {
      ...
      accessor: "approved",
      sortable: true,
      cell: (v) => <span className="text-emerald-700 font-bold">{v}</span>,
    },
    { header: "AVG APPROVAL TIME", accessor: "avgDays", sortable: true },
    {
      header: "SLA COMPLIANCE",
      accessor: "slaCompliance",
      sortable: true,
      cell: (v) => (
    ...
    <div className="space-y-6 p-6 overflow-y-auto h-full bg-[#f4f7f4]/40 animate-fadeIn text-brand-darkest">
      ...
      <div className="bg-white p-5 rounded-2xl border border-gray-150 shadow-sm">
        ...
        <p className="text-xs text-gray-500 mt-1">
          Monitor application processing timelines, officer turnaround
          performance, and reallocate caseloads to bypass verification
          bottlenecks.
        </p>
      </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <StatsCard
          ...
          value="5.8 Days"
          trend="SLA Target: 7 Days"
          trendType="success"
          subtext="State level average"
        />
        <StatsCard
          title="Verification Backlogs"
          value={Object.values(backlogs).reduce((a, b) => a + b, 0)}
          trend="+4.2% week-on-week"
          trendType="danger"
          subtext="Cases pending review"
        />
        <StatsCard
          title="SLA Compliance Rate"
          value="81.2%"
          trend="Breached: 1 District"
          trendType="danger"
          subtext="State compliance average"
        />
      </div>
      ...
      <div className="bg-white p-5 rounded-2xl border border-gray-150 shadow-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
          {pipeline.map((step, idx) => (
            <div
              key={idx}
              className="bg-gray-50/50 border border-gray-150 rounded-2xl p-4 flex flex-col justify-between h-24"
            >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white p-5 rounded-2xl border border-gray-150 shadow-sm flex flex-col justify-between">
          <div>
            ...
            <p className="text-[10px] text-gray-400 mb-4">
              Simulate dispatching verify workloads from backlogged offices to
            ...
            {reallocateSuccess ? (
              <div className="text-center py-6 space-y-3 bg-[#f4f7f4]/45 border border-brand-medium/10 rounded-2xl animate-fadeIn">
                ...
                <p className="text-[10px] text-gray-500 leading-relaxed px-4">
                  ...
                  <span className="font-bold">{backlogTransferCount}</span>{" "}
                  cases from {reallocateFrom} to {reallocateTo}.
                </p>
                <button
              ...
              >
                ...
                <button
                  type="submit"
                  disabled={
                    reallocateProgress || reallocateFrom === reallocateTo
                  }
        ...
        <div className="lg:col-span-2 bg-white p-5 rounded-2xl border border-gray-150 shadow-sm flex flex-col justify-between">
          <div>
            ...
            <p className="text-[10px] text-gray-400 mb-4">
              Geographic units violating the 7-day state-mandated scheme
              clearance timeline. Action required.
            </p>
            ...
            <div className="space-y-3">
              <div className="p-3 bg-red-50/50 border border-red-100 text-red-950 rounded-xl text-xs flex justify-between items-center">
                <div className="space-y-0.5">
                  <p className="font-bold">
                    District Panipat: Critical SLA Breach
                  </p>
                  <p className="text-gray-500 font-semibold">
                    Average cycle is 14.5 days. 340 pending cases backlog.
                  </p>
                </div>
                <span className="text-[10px] bg-red-100 text-red-700 px-2 py-0.5 rounded font-black shrink-0">
                  14.5 Days
                </span>
              </div>
              ...
              <div className="p-3 bg-amber-50/50 border border-amber-100 text-amber-950 rounded-xl text-xs flex justify-between items-center">
                <div className="space-y-0.5">
                  <p className="font-bold">
                    District Jhajjar: Pending Warning Threshold
                  </p>
                  <p className="text-gray-500 font-semibold">
                    Average cycle is 8.2 days. 210 pending cases backlog.
                  </p>
                </div>
                <span className="text-[10px] bg-amber-100 text-amber-700 px-2 py-0.5 rounded font-black shrink-0">
                  8.2 Days
                </span>
              </div>
              ...
              <div className="p-3 bg-amber-50/50 border border-amber-100 text-amber-950 rounded-xl text-xs flex justify-between items-center">
                <div className="space-y-0.5">
                  <p className="font-bold">
                    District Rohtak: Impending Bottleneck
                  </p>
                  <p className="text-gray-500 font-semibold">
                    Average cycle is 6.5 days. 180 pending cases backlog.
                  </p>
                </div>
                <span className="text-[10px] bg-amber-100 text-amber-700 px-2 py-0.5 rounded font-black shrink-0">
                  6.5 Days
