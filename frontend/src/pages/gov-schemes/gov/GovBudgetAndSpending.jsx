...
export default function GovBudgetAndSpending() {
  ...
  const columns = [
    ...
    {
      header: "ALLOCATED POOL",
      accessor: "allocated",
      sortable: true,
      cell: (v) => `₹${v} Cr`,
    },
    {
      header: "UTILIZED POOL",
      accessor: "utilized",
      sortable: true,
      cell: (v) => `₹${v} Cr`,
    },
  ...
  const riskAlerts = [
    {
      title: "Panipat Sub-plan Delay",
      desc: "₹16.1 Cr remain unspent in Panipat micro-irrigation accounts. Capital deployment index is 54%.",
      type: "danger",
    },
    {
      title: "Slow-moving Capacity Funds",
      desc: "State level farmer training allocations show only 49% utilization with only 3 months left in fiscal cycle.",
      type: "warning",
    },
    {
      title: "Disbursement Lag",
      desc: "PMFBY seasonal claim clearance shows average 15 days delay in 4 central cooperative banks.",
      type: "warning",
    },
  ];
    ...
    <div className="space-y-6 p-6 overflow-y-auto h-full bg-[#f4f7f4]/40 animate-fadeIn text-brand-darkest">
      ...
      <div className="bg-white p-5 rounded-2xl border border-gray-150 shadow-sm">
        ...
        <p className="text-xs text-gray-500 mt-1">
          Track public expenditures, verify geographic allocation pools,
          identify capital blockages, and model fiscal runway.
        </p>
      </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-5 gap-4">
        ...
        <StatsCard
          title="Released Pool"
          value={budgetSummary.released}
          subtext="Expedited to district offices"
        />
        <StatsCard
          title="Utilized Pool"
          value={budgetSummary.utilized}
          trend={budgetSummary.rate}
          trendType="success"
          subtext="Direct benefit transfers & asset builds"
        />
        <StatsCard
          title="Unspent Balance"
          value={budgetSummary.remaining}
          subtext="Remaining fiscal balance"
        />
        <StatsCard
          title="Runway Remaining"
          value="3.2 Months"
          subtext="Calculated from baseline speed"
        />
      </div>
        ...
        <div className="bg-white p-5 rounded-2xl border border-gray-150 shadow-sm flex flex-col justify-between">
          <div>
            ...
            <p className="text-[10px] text-gray-400 mb-4">
              Telemetry monitoring indicating delayed capital disbursement, slow
              audits, or low utilization rates.
            </p>
              ...
              {riskAlerts.map((alert, idx) => (
                ...
                >
                  <div className="flex justify-between items-center text-xs font-bold">
                    ...
                    <span
                      className={`text-[9px] px-1.5 py-0.25 rounded-md ${
                        alert.type === "danger"
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white p-5 rounded-2xl border border-gray-150 shadow-sm flex flex-col justify-between">
          <div>
            ...
            <p className="text-[10px] text-gray-400 mb-4">
              Select future forecast duration to estimate cumulative
              expenditures and budget shortfalls.
            </p>
            ...
            <div className="space-y-4 text-xs font-semibold">
              <div>
                ...
                <input
                  ...
                  className="w-full accent-[#28a745] cursor-pointer"
                />
              </div>
