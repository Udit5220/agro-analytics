          ...
          <div className="flex flex-wrap gap-4">
            ...
            <div className="flex items-end gap-2">
              <button
                ...
                disabled={refreshing}
                className="px-4 py-2 bg-brand-dark hover:bg-[#132a13] text-white rounded-lg font-bold text-sm transition flex items-center gap-2 disabled:opacity-50 cursor-pointer"
              >
                {refreshing ? (
                    ...
                    <div key={disease} className="flex items-center gap-2">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="h-1.5 bg-gray-100 rounded-full overflow-hidden">
                          <div
                            className="h-full bg-brand-medium rounded-full transition-all duration-500"
