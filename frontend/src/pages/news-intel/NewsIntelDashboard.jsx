...
import bannerImg from "../../assets/images/News Intelligence Module.png";
  ...
  const metrics = [
    {
      ...
      value: "200+",
      sub: "Real-time crawler",
      color: "text-[#31572c] bg-[#31572c]/10",
    },
    {
      label: "Daily Articles",
      value: "128",
      sub: "Processed by LLM",
      color: "text-emerald-700 bg-emerald-50",
    },
    {
      label: "Market Sentiment",
      value: "Positive",
      sub: "+0.62 Index score",
      color: "text-sky-700 bg-sky-50",
    },
    {
      label: "Policy Alerts",
      value: "3 Active",
      sub: "Critical ratings",
        ...
        <div className="relative z-10 w-full md:w-2/3">
          <div>
            ...
            <p className="text-gray-500 text-[11px] md:text-xs font-medium mt-1.5">
              Track news crawling nodes, state policy updates, and real-time AI
              agricultural sentiment ratings.
            </p>
          </div>
        </div>
            ...
            <table className="w-full text-left border-collapse min-w-[500px]">
              ...
              <tbody className="divide-y divide-gray-100/60">
                {newsItems.map((item, idx) => (
                  ...
                  >
                    <td className="p-3 pl-1 text-gray-900 font-bold leading-snug max-w-[280px]">
                      {item.title}
                    </td>
                    <td className="p-3 text-amber-700 font-black">
                      {item.impact}
                    </td>
                    <td className="p-3 text-[#31572c] font-black">
                      {item.rating}
                    </td>
                    <td className="p-3 text-right pr-2 text-gray-450 font-bold">
                      {item.time}
                    </td>
                  </tr>
                ))}
        ...
        <div className="bg-white rounded-2xl p-5 border border-gray-200/60 shadow-sm space-y-4">
          ...
          <div className="space-y-3">
            <div className="bg-[#f4f7f4] border border-gray-150 p-3 rounded-xl flex gap-2.5">
              ...
              <div>
                ...
                <span className="text-[11px] text-gray-650 block mt-0.5 leading-relaxed font-semibold">
                  Crop procurement e-registrations have commenced in Palwal and
                  Rohtak districts. Register land details early.
                </span>
              </div>
            </div>
            ...
            <div className="bg-red-50 border border-red-200 text-red-950 p-3 rounded-xl flex gap-2.5">
              ...
              />
              <div>
                <span className="text-[10px] font-bold text-red-900 block">
                  Supply Chains Alert
                </span>
                <span className="text-[11px] text-red-950 block mt-0.5 leading-relaxed font-medium">
                  Trucking volumes down due to local regional bypass maintenance
                  on National Highway 44. Expected delays 12h.
                </span>
              </div>
            </div>
          </div>
