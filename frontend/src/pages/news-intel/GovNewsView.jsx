...
import { ChevronDown, ChevronUp, ShieldAlert, Landmark, MessageSquare, Database, Map, FileText, CheckCircle2, Clock, AlertTriangle, ArrowRight, Loader2, Info as LucideInfo } from 'lucide-react';
import { BarChart, Bar, LineChart, Line, XAxis, YAxis, Tooltip, ResponsiveContainer, CartesianGrid } from 'recharts';

// Reusable Accordion Item Component (Rose/Red Theme)
...
// Global Page Chart Gallery Component (Rose/Red Theme)
...
export default function GovNewsView({ data, subPath }) {
    ...
    return (
      <div className="w-full pb-20">
        <div className="text-center py-16 text-emerald-500 bg-emerald-50 rounded-2xl border border-emerald-200 border-dashed">
          ...
          <p className="text-sm font-medium">{t("Aggregating State Policy & Crisis Intelligence...")}</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="w-full pb-20 animate-fadeIn">
      ...
      <div className="mb-4 flex items-center justify-between">
        <h3 className="text-sm font-bold text-emerald-800 uppercase tracking-wider">{t("Administrative Intelligence synthesis")}</h3>
