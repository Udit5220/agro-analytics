...
import { ChevronDown, ChevronUp, AlertCircle, TrendingUp, Cpu, Wallet, MapPin, Clock, BarChart3, CheckCircle2, ShieldAlert, Loader2, Info as LucideInfo } from 'lucide-react';
...
// Global Page Chart Gallery Component
...
export default function FarmerNewsView({ data, subPath }) {
    ...
    return (
      <div className="w-full pb-20">
        <div className="text-center py-16 text-emerald-500 bg-emerald-50 rounded-2xl border border-emerald-200 border-dashed">
          ...
          <p className="text-sm font-medium">{t("Synthesizing live intelligence feeds...")}</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="w-full pb-20 animate-fadeIn">
      ...
      <div className="mb-4 flex items-center justify-between">
        <h3 className="text-sm font-bold text-emerald-800 uppercase tracking-wider">{t("Live Intelligence Feed")}</h3>
