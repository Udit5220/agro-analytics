...
import bannerImg from "../../assets/images/Weather & Reservoir Intel.png";
...
export default function WeatherReservoirDashboard() {
  ...
  const reservoirs = [
    {
      name: "Hathnikund Barrage (Yamunanagar)",
      level: "72.5%",
      status: "Normal Flow",
      inflow: "18,200 cusecs",
    },
    {
      name: "Kaushalya Dam (Panchkula)",
      level: "61.2%",
      status: "Steady",
      inflow: "2,100 cusecs",
    },
    {
      name: "Ottu Barrage (Sirsa)",
      level: "58.6%",
      status: "Moderate",
      inflow: "4,500 cusecs",
    },
        ...
        <div className="relative z-10 w-full md:w-2/3">
          <div>
            ...
            <p className="text-gray-500 text-[11px] md:text-xs font-medium mt-1.5">
              Monitor real-time weather alerts, telemetry sensor feeds, and
              active reservoir volume ratings.
            </p>
          </div>
        </div>
              ...
              <tbody className="divide-y divide-gray-100/60">
                {reservoirs.map((item, idx) => (
                  ...
                  >
                    ...
                    <td className="p-3 text-right pr-2 text-slate-700 font-bold">
                      {item.inflow}
                    </td>
                  </tr>
                ))}
            ...
            <div className="bg-emerald-50/50 border border-emerald-100 p-3 rounded-xl flex gap-2.5">
              ...
              <div>
                ...
                <span className="text-[11px] text-gray-600 block mt-0.5 leading-relaxed font-semibold">
                  Light-to-medium rain showers predicted next Tuesday. Delay
                  scheduled sprinkler runs.
                </span>
              </div>
            </div>
            ...
            <div className="bg-amber-50/50 border border-amber-100 p-3 rounded-xl flex gap-2.5">
              ...
              <div>
                ...
                <span className="text-[11px] text-gray-600 block mt-0.5 leading-relaxed font-medium">
                  Ottu Barrage reported minor siltation spikes. High filtration
                  recommended for tube-wells.
                </span>
              </div>
            </div>
          </div>
