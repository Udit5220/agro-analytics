...
// --- EXPANDED MASTER LIFECYCLE TIMELINE SEED REGISTRY ---
const AGRONOMIC_MASTER_TIMELINES = {
  // Kharif Staples & Cash Crops
  rice: {
    hindiName: "धान",
    timeline: {
      Jun: ["Sowing"],
      Jul: ["Sowing", "Irrigation"],
      Aug: ["Irrigation", "Fertilizer"],
      Sep: ["Irrigation"],
      Oct: ["Harvest"],
      Nov: ["Harvest"],
  ...
  mustard: {
    ...
    timeline: {
      Oct: ["Sowing"],
      Nov: ["Sowing", "Irrigation"],
      Dec: ["Irrigation", "Fertilizer"],
      Jan: ["Irrigation"],
      Feb: ["Harvest"],
      Mar: ["Harvest"],
    },
  ...
  moong: {
    ...
    timeline: {
      Mar: ["Sowing"],
      Apr: ["Sowing", "Irrigation"],
      May: ["Fertilizer", "Irrigation"],
      Jun: ["Harvest"],
    },
  },

  // Perennials / Multi-Season Commercial Crops
  // sugarcane: {
  //   hindiName: "गन्ना",
  //   timeline: {
  //     Mar: ["Sowing"],
  //     Apr: ["Irrigation"],
  //     May: ["Irrigation", "Fertilizer"],
  //     Jun: ["Irrigation"],
  //     Jul: ["Fertilizer"],
  //     Aug: ["Irrigation"],
  //     Sep: ["Irrigation"],
...
const CLIMATE_SEASON_METADATA = {
  Kharif: {
    months: "June – November",
    temp: "28°C – 36°C",
    humidity: "75% – 90%",
    desc: "Monsoon cycle optimized for high water-retaining clay soil matrices.",
  },
  Rabi: {
    months: "November – April",
    temp: "12°C – 25°C",
    humidity: "40% – 55%",
    desc: "Winter cycle utilizing residual moisture parameters and light irrigation shifts.",
  },
  Zaid: {
    months: "March – June",
    temp: "32°C – 44°C",
    humidity: "20% – 35%",
    desc: "Dry summer window optimized for high-intensity rapid lifecycle crops.",
  },
};
